...
> **NOTE:** The inline action is still considered a part of the resource it is nested under even though it's URI template is different to that of the resource.
